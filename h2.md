...
- Ajatuksena on pääsynhallinnalla estää käyttäjiä toimimasta oikeuksien ulkopuolella

- Rikkinäinen pääsynhallinta on yleisin ja vakavin haavoittuvuus sovelluksissa

- voi johtaa luvattomaan tiedon katseluun, muokkaamiseen, poistamiseen tai antaa pääsyn toimintoihin, joita käyttäjällä ei pitäisi olla.

- Liian laajat oikeudet, ei pääsyntarkastuksia API-kutsuissa

- Suojautua voi antaa oikeuksia vain tarvittaessa ja käyttää keskitettyä tapaa hallita käyttäjiä
