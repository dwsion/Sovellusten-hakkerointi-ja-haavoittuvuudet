...
Pakolliset tehtävät oli nyt valmiina ja pidin pienen tauon ennenkuin aloitin katsomaan d-kohtaa.
...
Yritin ladata ensin base64:sen koneelle, mutta se löytyikin jo sieltä:

<img width="530" height="171" alt="image" src="https://github.com/user-attachments/assets/f47d0a87-f062-4da3-ad3b-088a85be3a80" />

<img width="767" height="455" alt="image" src="https://github.com/user-attachments/assets/8c3ceebe-e2ec-4e7d-9dd5-51f51fcdccde" />

Kokeilin seuraavaksi kääntää tuota suoraa base64:ksi, mutta se ei toimi tällä tapaa. Löysin superuserin sivuilta ratkaisun, joka vaati lataamaan myös xxd:n koneelle.

<img width="1305" height="389" alt="image" src="https://github.com/user-attachments/assets/8b4d668c-5039-458f-a6af-cbf25e88a34c" />

        (superuser.com)

Tämän jälkeen voisin kääntää HEx- arvon ensin binääriksi, joka sitten kääntyy base64-muotoon, eli seuraavasti:

        echo 49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d | xxd -r -p | base64

<img width="1300" height="83" alt="image" src="https://github.com/user-attachments/assets/2dcfd54a-54c7-4b34-8ef5-7b09bff316ae" />

Tulos täsmää sivun ratkaisuun:

<img width="2332" height="896" alt="image" src="https://github.com/user-attachments/assets/39453dcd-700f-4fd6-9582-283448031504" />
...
- Superuser.com,how-can-i-convert-from-hex-to-base64. luettavissa: https://superuser.com/questions/158142/how-can-i-convert-from-hex-to-base64. luettu: 
